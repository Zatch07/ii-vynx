...
GlassRect {
    ...
    readonly property real nonAnimHeight: Math.max(cover.implicitHeight + Tokens.sizes.dashboard.mediaVisualiserSize * 2, details.implicitHeight, bongocat.implicitHeight) + Tokens.padding.large * 2
    readonly property real detailsHeightWithoutLyrics: details.implicitHeight - lyricsViewInDetails.implicitHeight

    readonly property bool lyricMenuOpen: false
