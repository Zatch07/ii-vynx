...
Item {
    ...
    component BatteryTank: GlassRect {
        id: batteryTank
    ...
    component StorageGaugeCard: GlassRect {
        id: storageGaugeCard
    ...
    component NetworkCard: GlassRect {
        id: networkCard
